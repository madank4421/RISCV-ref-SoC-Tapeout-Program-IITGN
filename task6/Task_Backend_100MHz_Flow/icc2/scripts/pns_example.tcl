...
create_pg_macro_conn_pattern pad_pattern -pin_conn_type scattered_pin -layer {metal7 metal6}

#set all_pg_pads [get_cells * -hier -filter "ref_name==VDD_NS || ref_name==VSS_NS"]
set all_pg_pads [get_cells -hierarchical -filter pad_cell==true]

#set_pg_strategy s_pad -macros $all_pg_pads  -pattern {{name: pad_pattern} {nets: {VDD VDD_LOW VSS}}}
set_pg_strategy s_pad -macros $all_pg_pads  -pattern {{name: pad_pattern} {nets: {VDD VSS}}}
