...
#create_io_guide -side right -pad_cells { gpio9 gpio8 gpio7 gpio6 gpio5 gpio4 gpio3 gpio2 gpio1 ext_clk_buf ext_clk_sel_buf ext_reset_buf} -line {{3588 5188} 5188} 

#create_io_guide -side left -pad_cells { flash_io_buf_2 flash_io_buf_1 flash_io_buf_0 flash_clk_buf flash_csb_buf trap_buf ser_tx_buf overtemp_ena_buf rcosc_ena_buf comp_pinputsrc_buf0 comp_pinputsrc_buf1 comp_ninputsrc_buf0 } -line {{0 0} 5188} 

#create_io_guide -side top -pad_cells {comp_ninputsrc_buf1 comp_ena_buf opamp_bias_ena_buf opamp_ena_buf analog_out_sel_buf gpio0 comp_in_buf flash_io_buf_3 irq_pin_buf overtemp_buf pll_clk_buf} -line {{0 5188} 3588}

#create_io_guide -side bottom -pad_cells { xtal_in_buf spi_sck_buf ser_rx_buf reset_buf rcosc_in_buf gpio10 gpio11 gpio12 gpio13 gpio14 gpio15 } -line {{3588 0} 3588}
