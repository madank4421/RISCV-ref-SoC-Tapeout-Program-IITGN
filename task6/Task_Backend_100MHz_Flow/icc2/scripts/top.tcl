...
#####madank
# After floorplan, BEFORE placement:
#add_power_pads -nets {VDD VSS} -direction in -side {top bottom left right} -layer {M1 M2}
#global_net_connect VDD -type pgpin -pin VDD* -inst *
#global_net_connect VSS -type pgpin -pin VSS* -inst *
