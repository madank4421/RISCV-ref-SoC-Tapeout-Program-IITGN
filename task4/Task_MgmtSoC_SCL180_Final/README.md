...
# Management SoC DV – Run-2 (Synthesized SRAM) 

Now let us synthesize our vsdcaravel with the SRAM modules.
...
Use the below synth.tcl for ynthesis without blackboxing:
